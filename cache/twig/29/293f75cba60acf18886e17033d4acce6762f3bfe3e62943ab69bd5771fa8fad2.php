...
/* modular.html.twig */
class __TwigTemplate_22468cea3cdb0c54b9d1713df22355340602d7e1603bee3582e22095b43591c5 extends Twig_Template
{
...
";
    ...
    public function block_header_navigation($context, array $blocks = array())
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["mitem"]) {
                ...
                <a href=\"";
                // line 38
                echo twig_escape_filter($this->env, $this->getAttribute($context["mitem"], "url", array()), "html", null, true);
                echo "\">
                    ";
                // line 39
                if ($this->getAttribute($context["mitem"], "icon", array())) {
                    echo "<i class=\"fa fa-";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["mitem"], "icon", array()), "html", null, true);
                    echo "\" aria-hidden=\"true\"></i>";
                }
                // line 40
                echo "                    ";
                echo twig_escape_filter($this->env, $this->getAttribute($context["mitem"], "text", array()), "html", null, true);
                echo "
                </a>
            </li>
        ";
    ...
    public function getpageLinkName($__text__ = null, ...$__varargs__)
    {
        ...
        ob_start();
        try {
            echo twig_escape_filter($this->env, twig_replace_filter(twig_lower_filter($this->env, (isset($context["text"]) ? $context["text"] : null)), array(" " => "_")), "html", null, true);
        } catch (Exception $e) {
            ob_end_clean();
...
{% block content %}
    ...
    {% endfor %}
{% endblock %}
", "modular.html.twig", "/Users/emilkarlsson/Downloads/grav-skeleton-helium-site 2/user/plugins/gantry5/engines/nucleus/templates/modular.html.twig");
    }
}
