...
class __TwigTemplate_78e0ef1304d7ac86c71bea6ccc5cdfa164473c9aaac22402b8dedf138b3054b8 extends Twig_Template
{
    ...
    ";
        ...
        ";
                ...
                if ($this->getAttribute($context["paginate"], "isCurrent", array())) {
                    // line 17
                    echo "            <li><span>";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["paginate"], "number", array()), "html", null, true);
                    echo "</span></li>
        ";
...
{% endif %}
", "partials/pagination.html.twig", "/Users/emilkarlsson/Code/lundbergsab/user/plugins/pagination/templates/partials/pagination.html.twig");
    }
}
